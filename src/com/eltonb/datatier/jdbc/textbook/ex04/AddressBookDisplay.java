package com.eltonb.datatier.jdbc.textbook.ex04;
...
public class AddressBookDisplay extends JFrame
{
   ...
   public AddressBookDisplay()
   {
      ...
      previousButton.addActionListener(evt -> previousButtonActionPerformed(evt)); // end call to addActionListener
      ...
      indexTextField.setHorizontalAlignment(
         JTextField.CENTER);
      indexTextField.addActionListener(evt -> indexTextFieldActionPerformed(evt)); // end call to addActionListener
      ...
      nextButton.addActionListener(evt -> nextButtonActionPerformed(evt)); // end call to addActionListener
      ...
      queryButton.addActionListener(evt -> queryButtonActionPerformed(evt)); // end call to addActionListener
      ...
      browseButton.addActionListener(evt -> browseButtonActionPerformed(evt)); // end call to addActionListener

      add(browseButton);

      insertButton.setText("Insert New Entry");
      insertButton.addActionListener(evt -> insertButtonActionPerformed(evt)); // end call to addActionListener
